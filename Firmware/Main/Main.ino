...
#define rotaryPin_A 6  //17//12
#define rotaryPin_B 5  //16//13
#define rotaryButtonPin 7  //23//8
...
/// GLOBAL VARIABLES RESPIRADOR

unsigned int respiraciones_minuto = 0;  // unidades   minimo nnnn maximo    nnn
unsigned int volumen_insuflar = 0;  // en cm3    minimo   nnn   maximo  ver maximo ambu
...
menu_type menu[12] = {}; //initilizing menu array, use a number >= than the number of menu options
